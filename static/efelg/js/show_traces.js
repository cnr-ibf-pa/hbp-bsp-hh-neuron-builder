...
function closeWarningDiv() {
    document.getElementById("e-st-warning-div").style.display = "none";
    ...
    $submitForm.submit(function(e){
        ...
        if (list_len == 0) {
            ...
            for (var i = 0; i < list_len; i++){
                ...
                cellname_span.className = "simple-span  center-container row-center-container";
                var textnode = document.createTextNode(crr_key); 
                cellname_span.appendChild(textnode);

                crr_div.appendChild(cellname_span);
                var stim_span = document.createElement("SPAN");
                stim_span.className = "simple-span  center-container row-center-container";
                var stimtext = document.createTextNode("Stimuli: ");
                var stimtextblank = document.createTextNode(" - ");
                stim_span.appendChild(stimtext);
                for (var j = 0; j < crr_stim.length; j++){
                    var stimtextnode = document.createTextNode(crr_stim[j] + "; ");

...
class Extractor(object):
	...
	# llb #logger.info('mainname')
	# llb #logger.info(mainname)
        # self.maindirname = "./" + mainname + "/" # commented by llb
        self.maindirname = mainname + os.sep # llb
        #tools.makedir(self.maindirname) #commented by llb
    ...
    def process_file(self, filename, cellname, expname, idx_file):
        ...
        if self.format == 'igor':
            ...
            # llb #logger.debug(" Adding igor file with ordinal %s", ordinal)
    ...
    def plt_traces(self):
        ...
        # llb #logger.info(" Plotting traces")
        ...
        for i_cell, cellname in enumerate(self.dataset):
            ...
            for i_exp, expname in enumerate(dataset_cell_exp):
                ...
                if 'threshold' in self.cells[cellname]['experiments'][expname]:
                    ...
                    # llb #logger.info(" Setting threshold to %f", threshold)
    ...
    def mean_features(self):
        ...
        # llb #logger.info(" Calculating mean features")
        ...
        for i_cell, cellname in enumerate(self.dataset):
            ...
            if 'expthreshold' in self.options:
                ...
                # llb #logger.info(" %s threshold amplitude: %f hypamp: %f", cellname, amp_threshold, mean_hypamp)
    ...
    def plt_features(self):
        ...
        # llb #logger.info(" Plotting features")
    ...
    def analyse_threshold(self):
        ...
        # llb #logger.info(" Analysing threshold and hypamp and saving files to %s", self.maindirname)
    ...
    def create_feature_config(self, directory, dataset, version=None):
        ...
        # llb #logger.info(" Saving config files to %s", directory)

...
MECHANISMS_PROCESS_ERROR = '<b>Error !</b><br><br>Something went wrong while mechanisms files were building.<br>Please, take a look on the files and if the problem persists contact the <a href="https://ebrains.eu/support" target="_blank">EBRAINS support</a>.'

...
describe('NeuroFeatureExtract automatic tests.', () => {
    ...
    const URL = (Cypress.env('https') ? 'https://' : 'http://')
        .concat(Cypress.env('host'))
        .concat(':')
        .concat(Cypress.env('port'))
        .concat('/efelg/');
    ...
    it('NFE upload json trace test.', () => {
        ...
        cy.get('#wait-message-div', {timeout: 600000}).should('be.not.visible');
        cy.get('#user_files_1').selectFile('cypress/fixtures/json_example.json', {'force': true});
    ...
    it('NFE upload abf trace with .json metadata test.', () => {
        ...
        cy.get('#wait-message-div', {timeout: 600000}).should('be.not.visible');
        cy.get('#user_files_1').selectFile(['cypress/fixtures/abf_example.abf', 'cypress/fixtures/abf_example_metadata.json'], {'force': true});
